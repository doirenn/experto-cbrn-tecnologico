...
## Pilares y hermanos abiertos

| Repo | Identidad |
| --- | --- |
| EXPERTO DESASTRES NATURALES | Amenaza natural, alerta, NDMO, Sendai |
...
6. Donaciones y cash
7. Comunicación / AAP / infodemia
8. Logística, WASH+alimentos, alojamiento, educación, derecho, clima/finanzas

Inventario completo: el mismo archivo en los pilares (`knowledge/research/mapa-expertos-hermanos.md`).

## Cruce desde este pilar
